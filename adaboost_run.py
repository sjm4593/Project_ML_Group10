...
def main():
    ...
    parser.add_argument(
        "--n_models", type=int, default=1, help="How many models to train with adaboost"
    )
    ...
    if args.do_train:
        ...
        train_dataset: TextDataset = load_and_cache_examples(
        ...
        # Adaboost will resample the dataset

        datacount = len(train_dataset.examples)
        ...
        dataset_weights = [1 / datacount] * datacount
        models = []
        models_vote = []
